    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: const [
          ...
          SizedBox(height: 12),
          Text(
            '• Photograph indicator plants for on-device species classification.',
          ),
          Text(
            '• Log vigour, leaf colour, density, local name, and local significance.',
          ),
          Text('• Recommend leaf tissue ICP-MS follow-up and XRF transects.'),
          Text(
            '• Queue low-confidence observations for active-learning retraining.',
          ),
        ],
      ),
    );
