...
from backend.ml.domain_models import train_spectral_cnn
...
ARTIFACT_DIR = Path("artifacts/models/spectral")
...
def _load_training_data(
    *,
    ...
    if data_source in {"corpus", "real", "usgs"}:
        try:
...
def train_spectral_classifier(
    *,
    ...
    checkpoint_body = train_spectral_cnn(
        x_train,
        y_train,
    ...
    if len(y_val):
        ...
        val_pred, val_probs = predict_spectral_cnn(checkpoint_body, x_val)
